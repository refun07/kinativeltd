...
const slides: Slide[] = [
    {
        id: 1,
        title: "Advanced CRM",
        description: "প্যানেল থেকেই কাস্টমারকে সরাসরি WhatsApp, Email এবং SMS পাঠানোর সুবিধা।",
    ...
    },
    {
        ...
        description: "ডিসকাউন্ট টাইপ, ইউসেজ রেস্ট্রিকশন এবং ক্যাটাগরি অনুযায়ী কাস্টম কুপন কোড তৈরির স্মার্ট সিস্টেম।",
    ...
    },
    {
        ...
        description: "টার্গেটেড কাস্টমার সেগমেন্ট অনুযায়ী কাস্টম অফার এবং মেগা ক্যাম্পেইন ম্যানেজমেন্ট সিস্টেম।",
        image: "https://images.unsplash.com/photo-1551288049-bbbda536339a?q=80&w=2070&auto=format&fit=crop",
        icon: <Tag className="w-6 h-6" />
    }
];

const GrowthSlider: React.FC = () => {
    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center order-2 lg:order-1">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <div className="inline-flex p-4 bg-red-500/20 rounded-2xl mb-8">
                                <span className="text-red-400">{activeSlide.icon}</span>
                            </div>
                        ...
                        <div className="flex gap-2">
                            {slides.map((_, i) => (
                                <button
                                    ...
                                    className={`h-1.5 transition-all duration-500 rounded-full ${currentSlide === i ? 'w-8 bg-red-500' : 'w-2 bg-white/20'}`}
                                />
                            ))}
                        </div>
                    </div>
            ...
            <div className="absolute top-6 right-6 hidden lg:flex items-center gap-2 bg-black/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/5">
                ...
                <span className="text-[10px] font-bold text-white uppercase tracking-[0.2em]">Viral Growth Tools</span>
            </div>
        </div>
    );
};
